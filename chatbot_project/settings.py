...
SECRET_KEY = "django-insecure-6n%jz7m4ewd84(*v*&-+6d8-vg=dv64q@@d5d!b8cizu%8!3_@"
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "chatbot/templates")],  # 📌 Añadir esta línea si falta
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
